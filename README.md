...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,119 | 🐛 105 | 📅 2026-08-21 list thing.*
...
>
> 1. [Awesome Cloud Security Learning Resources](https://github.com/jassics/awesome-cybersecurity-learning-resources/blob/main/awesome-cloud-security-learning-resources.md) ⭐ 124 | 🐛 6 | 📅 2026-06-27
> 2. [AWS Security Study Plan](https://github.com/jassics/security-study-plan/blob/main/aws-security-study-plan.md) ⭐ 5,050 | 🐛 1 | 📅 2026-08-12
> 3. [AWS Security Interview Quesitons](https://github.com/jassics/security-interview-questions/blob/main/aws-security-interview-questions.md) ⭐ 484 | 🐛 0 | 📅 2026-07-04
> 4. [Cloud Security Roadmap](https://github.com/jassics/cybersecurity-roadmap/blob/master/cloud-security.md) ⭐ 463 | 🐛 0 | 📅 2026-05-10
...
1. \*[A very good repo for learning IAM based vulnerabilities](https://github.com/BishopFox/iam-vulnerable) ⭐ 589 | 🐛 0 | 🌐 HCL | 📅 2026-03-12
...
1. [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,008 | 🐛 470 | 🌐 Go | 📅 2026-08-26 - Audit git repos for secrets
2. [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,627 | 🐛 525 | 🌐 Go | 📅 2026-08-28 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
3. [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,715 | 🐛 338 | 🌐 Python | 📅 2026-08-28 - AWS Security Best Practices Assessment, Auditing, Hardening and Forensics Readiness Tool.
4. [Arsenal of AWS Security Tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools) ⭐ 9,502 | 🐛 11 | 🌐 Shell | 📅 2026-07-07 - Collection of all security category tools and products
5. [AWS Vault](https://github.com/99designs/aws-vault) ⭐ 8,985 | 🐛 2 | 🌐 Go | 📅 2025-12-30 - A vault for securely storing and accessing AWS credentials in development environments
6. [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,804 | 🐛 296 | 🌐 Python | 📅 2025-09-23 - Multi-Cloud Security Auditing Tool
7. [Cloud Mapper](https://github.com/duo-labs/cloudmapper) ⭐ 6,290 | 🐛 210 | 🌐 JavaScript | 📅 2024-07-15 - Analyze your AWS environments (Python)
8. [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,313 | 🐛 37 | 🌐 Python | 📅 2026-05-19 - AWS Penetration Testing Toolkits
9. [ConsoleMe](https://github.com/Netflix/consoleme) ⚠️ Archived - A Central Control Plane for AWS Permissions and Access
10. [CloudFox](https://github.com/BishopFox/cloudfox) ⭐ 2,565 | 🐛 10 | 🌐 Go | 📅 2026-08-20 - Automating situational awareness for cloud penetration tests
11. [AWS PWN](https://github.com/dagrz/aws_pwn) ⭐ 1,222 | 🐛 3 | 🌐 Python | 📅 2023-08-30 - A collection of AWS penetration testing junk
12. [Zeus](https://github.com/DenizParlak/Zeus) ⭐ 719 | 🐛 4 | 🌐 Shell | 📅 2020-02-04 - AWS Auditing and Hardening tool
...
16. [aws-lint-iam-policies](https://github.com/welldone-cloud/aws-lint-iam-policies) ⭐ 162 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Tool to find problems in identity-based and resource-based IAM policies
17. [s3dns](https://github.com/olizimmermann/s3dns) ⭐ 128 | 🐛 0 | 🌐 Python | 📅 2026-08-24 - Passive DNS-based discovery of S3 (and other cloud) buckets by resolving CNAMEs and IPs during recon—ideal for stealthy and early identification of cloud storage exposures
...
19. [boto3-refresh-session](https://github.com/michaelthomasletts/boto3-refresh-session) ⭐ 52 | 🐛 1 | 🌐 Python | 📅 2026-08-27 - A simple Python package for refreshing AWS temporary credentials in boto3 automatically. Supports MFA, IoT, and custom auth flows.
...
22. [CloudSecure](https://github.com/carlosinfantes/cloudsecure) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-07-10 - Open-source AWS security assessment platform with AI-powered analysis, Prowler integration, and automated CIS benchmark scanning. Built serverless with CDK, Lambda, and Step Functions
23. [S3 Security Scanner](https://github.com/TocConsulting/s3-security-scanner) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-06-29 - Comprehensive AWS S3 security scanner that analyzes bucket configurations, policies, and access controls
24. [AWS Security Products - Official](https://aws.amazon.com/products/security/) - Few Important tools that you should consider are:
    * 1.14 **AWS Conformance Packs:** A conformance pack is a collection of AWS Config rules and remediation actions that can be easily deployed as a single entity in an account and a Region or across an organization in AWS Organizations. [conformance packs on github](https://github.com/awslabs/aws-config-rules/tree/master/aws-config-conformance-packs) ⭐ 1,735 | 🐛 115 | 🌐 Python | 📅 2026-05-27
...
25. [S3 Inspector](https://github.com/kromtech/s3-inspector) - Tool to check AWS S3 bucket permissions
26. [AWS Pentesting/Red Team Methodology - by hacktricks](https://cloud.hacktricks.xyz/pentesting-cloud/aws-pentesting) - A Collection for AWS environment penetration testing methodology.
27. [AWS Pentesting/Red Team Methodology - by hackingthe.cloud](https://hackingthe.cloud/aws/general-knowledge/aws_organizations_defaults/) - A collection of attacks/tactics/techniques that can use by offensive security professionals during cloud exploitation.

## Security Practices and CTFs

1. [CloudGoat By Rhino Security Labs](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,712 | 🐛 24 | 🌐 Python | 📅 2026-04-28 - Vulnerable by Design AWS infrastructure setup tool
...
1. [Unencrypted md5 plaintext hash in metadata in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-76wf-9vgp-pj7w) ⭐ 4,622 | 🐛 89 | 🌐 C | 📅 2026-08-28
2. [CBC padding oracle issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-f5pg-7wfw-84q9) ⭐ 4,622 | 🐛 89 | 🌐 C | 📅 2026-08-28 : [CVE-2020-8911](https://nvd.nist.gov/vuln/detail/CVE-2020-8911)
3. [In-band key negotiation issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-7f33-f4f5-xwgw) ⭐ 4,622 | 🐛 89 | 🌐 C | 📅 2026-08-28 : [CVE-2020-8912](https://nvd.nist.gov/vuln/detail/CVE-2020-8912)
...
[List of Contributors](https://github.com/jassics/awesome-aws-security/graphs/contributors) ⭐ 1,585 | 🐛 5 | 📅 2026-04-03
