...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,904 | 🐛 107 | 📅 2026-09-02 list thing.*
...
>
> 1. [Awesome Cloud Security Learning Resources](https://github.com/jassics/awesome-cybersecurity-learning-resources/blob/main/awesome-cloud-security-learning-resources.md) ⭐ 138 | 🐛 0 | 📅 2026-09-14
> 2. [AWS Security Study Plan](https://github.com/jassics/security-study-plan/blob/main/aws-security-study-plan.md) ⭐ 5,087 | 🐛 0 | 📅 2026-09-14
...
> 4. [Cloud Security Roadmap](https://github.com/jassics/cybersecurity-roadmap/blob/master/cloud-security.md) ⭐ 484 | 🐛 0 | 📅 2026-09-22
...
1. [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,468 | 🐛 484 | 🌐 Go | 📅 2026-09-23 - Audit git repos for secrets
2. [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 28,039 | 🐛 552 | 🌐 Go | 📅 2026-09-24 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
3. [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,862 | 🐛 381 | 🌐 Python | 📅 2026-09-24 - AWS Security Best Practices Assessment, Auditing, Hardening and Forensics Readiness Tool.
4. [Arsenal of AWS Security Tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools) ⭐ 9,509 | 🐛 12 | 🌐 Shell | 📅 2026-07-07 - Collection of all security category tools and products
5. [AWS Vault](https://github.com/99designs/aws-vault) ⭐ 8,993 | 🐛 2 | 🌐 Go | 📅 2025-12-30 - A vault for securely storing and accessing AWS credentials in development environments
6. [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,827 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-Cloud Security Auditing Tool
...
8. [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,341 | 🐛 38 | 🌐 Python | 📅 2026-05-19 - AWS Penetration Testing Toolkits
9. [ConsoleMe](https://github.com/Netflix/consoleme) ⚠️ Archived - A Central Control Plane for AWS Permissions and Access
10. [CloudFox](https://github.com/BishopFox/cloudfox) ⭐ 2,579 | 🐛 10 | 🌐 Go | 📅 2026-08-20 - Automating situational awareness for cloud penetration tests
...
16. [Cynative](https://github.com/cynative/cynative) ⭐ 206 | 🐛 20 | 🌐 Go | 📅 2026-09-24 - Open-source framework for security agents with live, read-only access to your infrastructure (connects to AWS, GCP, Azure, self-managed Kubernetes, GitHub and GitLab).
...
1. [CloudGoat By Rhino Security Labs](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,736 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Vulnerable by Design AWS infrastructure setup tool
...
1. [Unencrypted md5 plaintext hash in metadata in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-76wf-9vgp-pj7w) ⭐ 4,653 | 🐛 94 | 🌐 C | 📅 2026-09-24
2. [CBC padding oracle issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-f5pg-7wfw-84q9) ⭐ 4,653 | 🐛 94 | 🌐 C | 📅 2026-09-24 : [CVE-2020-8911](https://nvd.nist.gov/vuln/detail/CVE-2020-8911)
3. [In-band key negotiation issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-7f33-f4f5-xwgw) ⭐ 4,653 | 🐛 94 | 🌐 C | 📅 2026-09-24 : [CVE-2020-8912](https://nvd.nist.gov/vuln/detail/CVE-2020-8912)
...
[List of Contributors](https://github.com/jassics/awesome-aws-security/graphs/contributors) ⭐ 1,599 | 🐛 6 | 📅 2026-09-14
