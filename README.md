...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,232 | 🐛 106 | 📅 2026-08-21 list thing.*
...
> 2. [AWS Security Study Plan](https://github.com/jassics/security-study-plan/blob/main/aws-security-study-plan.md) ⭐ 5,046 | 🐛 0 | 📅 2026-08-12
...
32. \*[A very good repo for learning IAM based vulnerabilities](https://github.com/BishopFox/iam-vulnerable) ⭐ 588 | 🐛 0 | 🌐 HCL | 📅 2026-03-12
...
14. [Breaking and Pwning Apps and Servers in AWS and Azure](https://github.com/appsecco/breaking-and-pwning-apps-and-servers-aws-azure-training) ⭐ 952 | 🐛 1 | 🌐 CSS | 📅 2022-11-26 - Previously an instructor led training now released as free and open source courseware for Cloud Pentesters
...
1. [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 28,922 | 🐛 461 | 🌐 Go | 📅 2026-08-19 - Audit git repos for secrets
2. [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,557 | 🐛 518 | 🌐 Go | 📅 2026-08-23 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
3. [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,657 | 🐛 278 | 🌐 Python | 📅 2026-08-22 - AWS Security Best Practices Assessment, Auditing, Hardening and Forensics Readiness Tool.
...
6. [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,796 | 🐛 295 | 🌐 Python | 📅 2025-09-23 - Multi-Cloud Security Auditing Tool
...
8. [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,306 | 🐛 37 | 🌐 Python | 📅 2026-05-19 - AWS Penetration Testing Toolkits
9. [ConsoleMe](https://github.com/Netflix/consoleme) ⚠️ Archived - A Central Control Plane for AWS Permissions and Access
10. [CloudFox](https://github.com/BishopFox/cloudfox) ⭐ 2,560 | 🐛 10 | 🌐 Go | 📅 2026-08-20 - Automating situational awareness for cloud penetration tests
...
16. [aws-lint-iam-policies](https://github.com/welldone-cloud/aws-lint-iam-policies) ⭐ 157 | 🐛 0 | 🌐 Python | 📅 2026-08-22 - Tool to find problems in identity-based and resource-based IAM policies
...
1. [CloudGoat By Rhino Security Labs](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,703 | 🐛 24 | 🌐 Python | 📅 2026-04-28 - Vulnerable by Design AWS infrastructure setup tool
...
1. [Unencrypted md5 plaintext hash in metadata in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-76wf-9vgp-pj7w) ⭐ 4,613 | 🐛 87 | 🌐 C | 📅 2026-08-22
2. [CBC padding oracle issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-f5pg-7wfw-84q9) ⭐ 4,613 | 🐛 87 | 🌐 C | 📅 2026-08-22 : [CVE-2020-8911](https://nvd.nist.gov/vuln/detail/CVE-2020-8911)
3. [In-band key negotiation issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-7f33-f4f5-xwgw) ⭐ 4,613 | 🐛 87 | 🌐 C | 📅 2026-08-22 : [CVE-2020-8912](https://nvd.nist.gov/vuln/detail/CVE-2020-8912)
