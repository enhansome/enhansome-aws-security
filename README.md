...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,977 | 🐛 106 | 📅 2026-09-02 list thing.*
...
>
> 1. [Awesome Cloud Security Learning Resources](https://github.com/jassics/awesome-cybersecurity-learning-resources/blob/main/awesome-cloud-security-learning-resources.md) ⭐ 136 | 🐛 0 | 📅 2026-09-14
> 2. [AWS Security Study Plan](https://github.com/jassics/security-study-plan/blob/main/aws-security-study-plan.md) ⭐ 5,086 | 🐛 0 | 📅 2026-09-14
...
> 4. [Cloud Security Roadmap](https://github.com/jassics/cybersecurity-roadmap/blob/master/cloud-security.md) ⭐ 482 | 🐛 0 | 📅 2026-09-22
...
1. [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,430 | 🐛 483 | 🌐 Go | 📅 2026-09-09 - Audit git repos for secrets
2. [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 28,025 | 🐛 566 | 🌐 Go | 📅 2026-09-22 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
3. [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,849 | 🐛 382 | 🌐 Python | 📅 2026-09-22 - AWS Security Best Practices Assessment, Auditing, Hardening and Forensics Readiness Tool.
4. [Arsenal of AWS Security Tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools) ⭐ 9,508 | 🐛 12 | 🌐 Shell | 📅 2026-07-07 - Collection of all security category tools and products
...
6. [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,826 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-Cloud Security Auditing Tool
...
8. [Pacu](https://github.com/RhinoSecurityLabs/pacu) ⭐ 5,339 | 🐛 38 | 🌐 Python | 📅 2026-05-19 - AWS Penetration Testing Toolkits
...
16. [Cynative](https://github.com/cynative/cynative) ⭐ 204 | 🐛 20 | 🌐 Go | 📅 2026-09-22 - Open-source framework for security agents with live, read-only access to your infrastructure (connects to AWS, GCP, Azure, self-managed Kubernetes, GitHub and GitLab).
...
20. [boto3-refresh-session](https://github.com/michaelthomasletts/boto3-refresh-session) ⭐ 52 | 🐛 3 | 🌐 Python | 📅 2026-09-22 - A simple Python package for refreshing AWS temporary credentials in boto3 automatically. Supports MFA, IoT, and custom auth flows.
...
1. [CloudGoat By Rhino Security Labs](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,732 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - Vulnerable by Design AWS infrastructure setup tool
...
1. [Unencrypted md5 plaintext hash in metadata in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-76wf-9vgp-pj7w) ⭐ 4,646 | 🐛 94 | 🌐 C | 📅 2026-09-21
2. [CBC padding oracle issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-f5pg-7wfw-84q9) ⭐ 4,646 | 🐛 94 | 🌐 C | 📅 2026-09-21 : [CVE-2020-8911](https://nvd.nist.gov/vuln/detail/CVE-2020-8911)
3. [In-band key negotiation issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-7f33-f4f5-xwgw) ⭐ 4,646 | 🐛 94 | 🌐 C | 📅 2026-09-21 : [CVE-2020-8912](https://nvd.nist.gov/vuln/detail/CVE-2020-8912)
...
[List of Contributors](https://github.com/jassics/awesome-aws-security/graphs/contributors) ⭐ 1,598 | 🐛 5 | 📅 2026-09-14
