...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,117 | 🐛 106 | 📅 2026-09-02 list thing.*
...
> 2. [AWS Security Study Plan](https://github.com/jassics/security-study-plan/blob/main/aws-security-study-plan.md) ⭐ 5,073 | 🐛 0 | 📅 2026-09-14
...
1. [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,364 | 🐛 482 | 🌐 Go | 📅 2026-09-09 - Audit git repos for secrets
2. [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 27,971 | 🐛 555 | 🌐 Go | 📅 2026-09-17 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
3. [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,830 | 🐛 378 | 🌐 Python | 📅 2026-09-17 - AWS Security Best Practices Assessment, Auditing, Hardening and Forensics Readiness Tool.
4. [Arsenal of AWS Security Tools](https://github.com/toniblyx/my-arsenal-of-aws-security-tools) ⭐ 9,507 | 🐛 12 | 🌐 Shell | 📅 2026-07-07 - Collection of all security category tools and products
5. [AWS Vault](https://github.com/99designs/aws-vault) ⭐ 8,990 | 🐛 2 | 🌐 Go | 📅 2025-12-30 - A vault for securely storing and accessing AWS credentials in development environments
6. [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,819 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-Cloud Security Auditing Tool
...
16. [Cynative](https://github.com/cynative/cynative) ⭐ 203 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Open-source framework for security agents with live, read-only access to your infrastructure (connects to AWS, GCP, Azure, self-managed Kubernetes, GitHub and GitLab).
...
20. [boto3-refresh-session](https://github.com/michaelthomasletts/boto3-refresh-session) ⭐ 52 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - A simple Python package for refreshing AWS temporary credentials in boto3 automatically. Supports MFA, IoT, and custom auth flows.
...
1. [Unencrypted md5 plaintext hash in metadata in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-76wf-9vgp-pj7w) ⭐ 4,639 | 🐛 94 | 🌐 C | 📅 2026-09-16
2. [CBC padding oracle issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-f5pg-7wfw-84q9) ⭐ 4,639 | 🐛 94 | 🌐 C | 📅 2026-09-16 : [CVE-2020-8911](https://nvd.nist.gov/vuln/detail/CVE-2020-8911)
3. [In-band key negotiation issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-7f33-f4f5-xwgw) ⭐ 4,639 | 🐛 94 | 🌐 C | 📅 2026-09-16 : [CVE-2020-8912](https://nvd.nist.gov/vuln/detail/CVE-2020-8912)
