...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,201 | 🐛 106 | 📅 2026-09-02 list thing.*
...
>
> 1. [Awesome Cloud Security Learning Resources](https://github.com/jassics/awesome-cybersecurity-learning-resources/blob/main/awesome-cloud-security-learning-resources.md) ⭐ 134 | 🐛 0 | 📅 2026-09-14
> 2. [AWS Security Study Plan](https://github.com/jassics/security-study-plan/blob/main/aws-security-study-plan.md) ⭐ 5,076 | 🐛 0 | 📅 2026-09-14
> 3. [AWS Security Interview Quesitons](https://github.com/jassics/security-interview-questions/blob/main/aws-security-interview-questions.md) ⭐ 489 | 🐛 0 | 📅 2026-07-04
> 4. [Cloud Security Roadmap](https://github.com/jassics/cybersecurity-roadmap/blob/master/cloud-security.md) ⭐ 480 | 🐛 0 | 📅 2026-05-10
...
1. [gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,402 | 🐛 484 | 🌐 Go | 📅 2026-09-09 - Audit git repos for secrets
2. [truffleHog](https://github.com/dxa4481/truffleHog) ⭐ 28,003 | 🐛 559 | 🌐 Go | 📅 2026-09-18 - Searches through git repositories for high entropy strings and secrets, digging deep into commit history
3. [Prowler](https://github.com/toniblyx/prowler) ⭐ 14,841 | 🐛 373 | 🌐 Python | 📅 2026-09-19 - AWS Security Best Practices Assessment, Auditing, Hardening and Forensics Readiness Tool.
...
6. [ScoutSuite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,822 | 🐛 298 | 🌐 Python | 📅 2025-09-23 - Multi-Cloud Security Auditing Tool
...
16. [Cynative](https://github.com/cynative/cynative) ⭐ 202 | 🐛 20 | 🌐 Go | 📅 2026-09-18 - Open-source framework for security agents with live, read-only access to your infrastructure (connects to AWS, GCP, Azure, self-managed Kubernetes, GitHub and GitLab).
...
18. [s3dns](https://github.com/olizimmermann/s3dns) ⭐ 129 | 🐛 0 | 🌐 Python | 📅 2026-09-14 - Passive DNS-based discovery of S3 (and other cloud) buckets by resolving CNAMEs and IPs during recon—ideal for stealthy and early identification of cloud storage exposures
...
1. [Unencrypted md5 plaintext hash in metadata in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-76wf-9vgp-pj7w) ⭐ 4,643 | 🐛 94 | 🌐 C | 📅 2026-09-18
2. [CBC padding oracle issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-f5pg-7wfw-84q9) ⭐ 4,643 | 🐛 94 | 🌐 C | 📅 2026-09-18 : [CVE-2020-8911](https://nvd.nist.gov/vuln/detail/CVE-2020-8911)
3. [In-band key negotiation issue in AWS S3 Crypto SDK for golang](https://github.com/google/security-research/security/advisories/GHSA-7f33-f4f5-xwgw) ⭐ 4,643 | 🐛 94 | 🌐 C | 📅 2026-09-18 : [CVE-2020-8912](https://nvd.nist.gov/vuln/detail/CVE-2020-8912)
...
[List of Contributors](https://github.com/jassics/awesome-aws-security/graphs/contributors) ⭐ 1,597 | 🐛 5 | 📅 2026-09-14
